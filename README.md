...
``$ pcx [<options>] <source directory> <destination directory>``
...
### Examples
```
Source Album $ pcx -a "Peter Crowcroft" -g "Mice All Over" . /run/media/user/F8950/Audiobooks/
```
...
```
Source Album $ pcx -dst . /run/media/user/F8950/Audiobooks/
```
